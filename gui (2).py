...
def populate_main_window(frm_main):
    ...
    lbl_radius = Label(frm_main, text="Radius (1 - 10):")

    # Create an integer entry box where the user will enter the radius.
    ent_radius = IntEntry(frm_main, width=4, lower_bound=1, upper_bound=10)
    ...
    lbl_area_units = Label(frm_main, text="cm^2")
