...
def make_full_name(given_name, family_name):
    ...
    make_full_name = f"{family_name};{given_name}"
    return make_full_name


def extract_family_name(make_full_name):
    ...
    semicolon_index = make_full_name.index("; ")

    # Extract a substring from the full name and return it.
    extract_family_name = make_full_name[0 : semicolon_index]
    return extract_family_name


def extract_given_name(make_full_name):
    ...
    # Extract a substring from the full name and return it.
    extract_given_name = make_full_name[semicolon_index + 2 : ]
    return extract_given_name
