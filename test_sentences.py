...
def test_get_preposition_phrase():
    ...
    # This loop will repeat the statements inside it 13 times.
    for _ in range(13):
...
def test_get_adjective():
    # 1. Test the get_adjective.

    adjectives = ["fat", "big", "elegant", "happy", "attractive", "colourful",
                  "short", "tall", "skinny", "beautiful", "gorgeous", "attractive"]
    # This loop will repeat the word inside it 12 times.
    for _ in range(12):
        ...
        # Verify that the adjective returned from the get_adjective function
