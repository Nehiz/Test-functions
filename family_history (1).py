...
def count_genders(people_dict):
    ...
    for key, value in people_dict.items():        
        if value[GENDER_INDEX] == 'M':
            ...
            j+=1
    print('Genders')        
    print(f'Number of males: {i}')
    print(f'Number of females: {j}')
...
def print_marriages(marriages_dict, people_dict):
    ...
    for key, value in marriages_dict.items():
        ...
        age_wedding_year_husbanb = value[WEDDING_YEAR_INDEX] - husband_info[BIRTH_YEAR_INDEX]
        ...
        age_wedding_year_wife = value[WEDDING_YEAR_INDEX] - wife_info[BIRTH_YEAR_INDEX]




        print(f'{husband_name} {age_wedding_year_husbanb} > {wedding_year} < {wife_name} {age_wedding_year_wife}')
